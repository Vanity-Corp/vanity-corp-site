...
export default function Globe3DDemoThird() {
  return (
    <div className="relative mx-auto h-[400px] w-full max-w-[1920px] overflow-hidden rounded-xl bg-white shadow-sm ring-1 shadow-black/10 ring-black/10 dark:bg-neutral-950">
